...
def plot_features_PCA(datapath):
	...
	ax1.scatter(sit_df['x'].values,sit_df['z'].values,c="tab:blue",label="Sit",s=2)
	ax1.scatter(sta_df['x'].values,sta_df['z'].values,c="tab:orange",label="Stand",s=2)
	ax1.scatter(wup_df['x'].values,wup_df['z'].values,c="tab:purple",label="W. Upstairs",s=2)
	ax1.scatter(wdo_df['x'].values,wdo_df['z'].values,c="tab:cyan",label="W. Downtairs",s=2)
	#ax1.scatter(lay_df['x'].values,lay_df['z'].values,c="tab:red",label="Lay")
	ax1.scatter(wal_df['x'].values,wal_df['z'].values,c="tab:green",label="Walk",s=2)	
